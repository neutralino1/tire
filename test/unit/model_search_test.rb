  ...
  module Model
    ...
    class SearchTest < Test::Unit::TestCase
      ...
      context "Model::Search" do
        ...
        should "limit searching in index for documents matching the model 'doc_type'" do
          Tire::Search::Search.
            expects(:new).
        ...
        should "search in custom name" do
          ...
          expected_options = { :type => ActiveModelArticleWithCustomIndexName.doc_type }
        ...
        should "allow to pass custom index name" do
          Tire::Search::Search.
            expects(:new).
            with('custom_index', { :type => ActiveModelArticle.doc_type }).
            returns(@stub).
            twice
